    ...
    ***************************************************************************** */
    ...
    var Slider = (function () {
        ...
        Slider.prototype.end = function () {
            var speed = this.speedCalc.get() * 10;
            var maxTime = Math.min(Math.max(Math.abs(speed), 100), 1000);
        ...
        Slider.prototype.moveTo = function (movementPosition, maxTime) {
            var _this = this;
            var calcMovementPosition = this.isFit ? Math.floor(movementPosition
            ...
            var tick = function (time) {
                if (elapsedTime > maxTime) {
                    _this.currentX = position - calcMovementPosition;
                ...
                var movement = offsetPosition * calcMovementPosition;
